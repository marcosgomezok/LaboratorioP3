...
urlpatterns = [
    ...
    path('administrador/movimiento/nuevo', views.movimientos, name='movimientos'),
    path('administrador/movimiento/lista', views.movimiento_lista, name='movimiento_lista'),
    path('administrador/movimiento/lista/detalle', views.movimiento_detalle, name='movimiento_detalle'),
    path('administrador/estadisticas', views.administrador_estadisticas, name='administrador_estadisticas'),
